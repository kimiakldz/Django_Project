    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subcategory', to='product.category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_id', models.ManyToManyField(related_name='products', to='product.category')),
                ('discount_id', models.ForeignKey(default=None, on_delete=django.db.models.deletion.SET_DEFAULT, to='product.discount')),
            ],
            options={
                'ordering': ('name',),
            },
